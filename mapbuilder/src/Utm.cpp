...
namespace mapping
{
	static const double DEG_TO_RAD_MULT = (2*3.14159265358979323846)/360.0;
	static const double RAD_TO_DEG_MULT = 360.0/(2*3.14159265358979323846);
	...
	*/
	...
	void LatLonToUtmWGS84( const double LatRad, const double LongRad, double &UTMNorthing, double &UTMEasting, char* UTMZone)
	{
		...
		double Lat  = LatRad*RAD_TO_DEG_MULT;
		double Long = LongRad*RAD_TO_DEG_MULT;

		//Make sure the longitude is between -180.00 .. 179.9
		double LongTemp = (Long+180)-int((Long+180)/360)*360-180; // -180.00 .. 179.9;

		//double LatRad = Lat;//*DEG_TO_RAD_MULT;
		//double LongRad = LongTemp*DEG_TO_RAD_MULT;
		...
		LongOriginRad = LongOrigin * DEG_TO_RAD_MULT;
		...
		A = cos(LatRad)*(LongTemp*DEG_TO_RAD_MULT-LongOriginRad);
